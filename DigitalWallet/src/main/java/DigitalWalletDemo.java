...
public class DigitalWalletDemo {
    public static void run() {
        ...
        // Create accounts
        Account account1 = new Account("A001", user1, "1234567890", Currency.DOLAR);
        Account account2 = new Account("A002", user2, "9876543210", Currency.REAL);
        ...
        // Transfer funds
        digitalWallet.transferFunds(account1, account2, new BigDecimal("100.00"), Currency.DOLAR);
        ...
        for (Transaction transaction : transactionHistory1) {
            ...
            System.out.println("Amount: " + transaction.amount() + " " + transaction.currency());
